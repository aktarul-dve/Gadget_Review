    ...
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <div className="p-6 mt-6 bg-white rounded-2xl shadow-md">
        <p className="text-gray-700">
          ...
          শুধুমাত্র যখন লাষ্টের কাজ করবেন তখন এডে ক্লিক করে একটি অ্যাপ ডাউনলোড করে অপেক্ষা করুন এবং ১২ ঘন্টা মোবাইল ফোনে রেখে দিন।
          তারপর আপনার টাকা যোগ হবে। ৪ ঘন্টা পর আবার চালু হবে।
