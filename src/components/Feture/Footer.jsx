        ...
        <footer className="bg-gray-900 text-gray-300 py-10 px-6 mt-10">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <Link to="/userLayout/privacyPolicy" className="hover:text-white">Privacy Policy </Link>
                        <Link to="/userLayout/termsConditition" className="hover:text-white">Terms & Conditions </Link>
                        <Link to="/userLayout/disclaimer" className="hover:text-white">Disclaimer </Link>
                    </ul>
                </div>
